const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Login-CT_lq6Gr.js","assets/proxy-CIFgaEQY.js","assets/lock-CoZrhtli.js","assets/shield-check-BIveGXso.js","assets/DeviceSetup-BFkKlhEh.js","assets/chevron-right-BIRGdOLx.js","assets/wifi-ozb9e_Jq.js","assets/Dashboard-CocZ1MbG.js","assets/shield-alert-mDB-I6Um.js","assets/zap-Dbl1kj5q.js","assets/Alerts-DBhlOiGB.js","assets/Settings-Abrczxiv.js"])))=>i.map(i=>d[i]);
...
const MOCK_DEVICES = [
  ...
  },
  {
    ...
    name: "Office",
    online: false,
    lastSeen: new Date(Date.now() - 25 * 60 * 1e3).toISOString()
  }
];
const MOCK_STATUS = {
  deviceId: "RKSH-A3F7",
...
const now = Date.now();
const mins = (n) => new Date(now - n * 60 * 1e3).toISOString();
const MOCK_LOGS = [
  {
    id: "log_001",
    timestamp: mins(3),
  ...
  persist(
    (set, get) => {
      ...
      return {
        ...
        logout: () => set({ user: null, isAuthenticated: false, hasDevices: false }),
        setHasDevices: (hasDevices) => set({ hasDevices }),
        // ── Device ──
        devices: MOCK_DEVICES,
        activeDeviceId: ((_a2 = MOCK_DEVICES[0]) == null ? void 0 : _a2.deviceId) ?? null,
        status: MOCK_STATUS,
        logs: [],
        isLoading: false,
        lastPoll: null,
        ...
        setStatus: (status) => set({ status, lastPoll: /* @__PURE__ */ new Date() }),
        appendLogs: (logs) => set((state) => ({
          logs: [...logs, ...state.logs].slice(0, 200)
        })),
        setLoading: (isLoading) => set({ isLoading }),
        updateZone: (zone, armed) => set((state) => ({
        ...
        invitedUsers: [
          {
            ...
            role: "control",
            addedAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1e3).toISOString()
          },
          {
            email: "guard@example.com",
            role: "view",
            addedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1e3).toISOString()
          }
        ],
        ...
        incrementUnread: () => set((state) => ({ unreadAlertCount: state.unreadAlertCount + 1 }))
      };
    },
    {
...
const mockStatuses = /* @__PURE__ */ new Map([
...
async function getDeviceStatus(deviceId) {
  ...
  return { ...status, lastSeen: (/* @__PURE__ */ new Date()).toISOString() };
}
...
async function pairDevice(deviceId, name) {
  await delay(600);
...
async function renameDevice(deviceId, name) {
  await randomDelay();
  mockDevices = mockDevices.map(
    (d) => d.deviceId === deviceId ? { ...d, name } : d
  );
  const status = mockStatuses.get(deviceId);
...
function useDeviceStatus(deviceId) {
  ...
  reactExports.useEffect(() => {
    if (!deviceId) return;
    setLoading(true);
    fetch2().finally(() => setLoading(false));
    intervalRef.current = setInterval(fetch2, 5e3);
    return () => {
      if (intervalRef.current) clearInterval(intervalRef.current);
    };
  }, [deviceId, fetch2, setLoading]);
...
function useAlarm() {
  ...
  const trigger = reactExports.useCallback(
    (event) => triggerAlarm(event),
    [triggerAlarm]
  );
  return { alarm, triggerAlarm: trigger, clearAlarm };
}
function startAlertAudio(ctxRef) {
  try {
...
function stopAlertAudio(ctxRef) {
  if (!ctxRef.current) return;
...
function AlarmOverlay() {
  ...
  const [disarming, setDisarming] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    ...
    return () => {
      window.triggerTestAlarm = void 0;
    };
  }, [triggerAlarm]);
  reactExports.useEffect(() => {
    if (alarm) {
  ...
  const isSOS = (alarm == null ? void 0 : alarm.type) === "SOS";
  const title = isSOS ? "SOS ALERT" : "INTRUDER ALERT";
  const emoji = isSOS ? "🆘" : "🚨";
  const detail = isSOS ? "Emergency SOS Activated" : (alarm == null ? void 0 : alarm.message) ?? "Motion detected";
  const ts = (alarm == null ? void 0 : alarm.timestamp) ? new Date(alarm.timestamp).toLocaleString(void 0, {
    dateStyle: "short",
    timeStyle: "medium"
  }) : "";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        opacity: fading ? 0 : 1,
        pointerEvents: fading ? "none" : void 0
      },
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-white/90 tracking-wide", children: detail }),
                ts && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50 font-mono mt-1", children: ts }),
                (alarm == null ? void 0 : alarm.source) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] font-bold tracking-widest font-display uppercase text-white/40", children: [
                  "SOURCE: ",
                  alarm.source
                ] })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 w-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: disarming ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 border-2 border-white border-t-transparent animate-spin rounded-full" }),
                      "DISARMING..."
                    ] }) : "⚠ DISARM ALL ZONES"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "DISMISS" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-[9px] tracking-normal normal-case font-normal",
                          style: { color: "rgba(255,180,0,0.7)" },
                          children: "Alert remains active on device"
                        }
                      )
                    ]
                  }
...
function DeviceSwitcher() {
  ...
  const isOnline = (status == null ? void 0 : status.online) ?? false;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", "data-ocid": "header.device_switcher", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold tracking-wider font-display uppercase text-foreground max-w-[80px] truncate", children: (active == null ? void 0 : active.name) ?? "No Device" }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: devices.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-muted-foreground font-mono", children: d.deviceId })
            ]
          },
          d.deviceId
        ))
...
function UserMenu() {
  ...
  const navigate = useNavigate();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", "data-ocid": "header.user_menu", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4 text-muted-foreground" })
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          user && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 border-b border-[#1E2A45]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground truncate", children: user.displayName }),
...
function AppLayout({ children }) {
  ...
  const getLastSeenText = () => {
    if (!lastPoll) return "";
    const mins2 = Math.floor((Date.now() - lastPoll.getTime()) / 6e4);
    if (mins2 < 1) return "Just now";
    return `${mins2}m ago`;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            ...
            style: {
              ...
              borderColor: "#1E2A45",
              backgroundImage: "repeating-linear-gradient(90deg, rgba(30,42,69,0.3) 0px, rgba(30,42,69,0.3) 1px, transparent 1px, transparent 24px)"
            },
            "data-ocid": "header.bar",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", "data-ocid": "header.logo", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(DeviceSwitcher, {}),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          style: {
                            ...
                            boxShadow: (status == null ? void 0 : status.online) ? "0 0 6px #00E676" : "0 0 6px #FF3B3B"
                          }
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          style: { color: (status == null ? void 0 : status.online) ? "#00E676" : "#FF3B3B" },
                          children: (status == null ? void 0 : status.online) ? "ONLINE" : "OFFLINE"
                        }
                      ),
                      !(status == null ? void 0 : status.online) && lastPoll && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground font-mono", children: [
                        "· ",
                        getLastSeenText()
                      ] })
                    ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
                    ...
                    children: [
                      ...
                      unreadAlertCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full flex items-center justify-center text-[9px] font-bold",
                          style: { backgroundColor: "#FF3B3B", color: "#fff" },
                          "data-ocid": "header.unread_badge",
                          children: unreadAlertCount > 9 ? "9+" : unreadAlertCount
                        }
                      )
                    ]
                  }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "aside",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col pt-4", children: NAV_ITEMS.map(({ to, icon: Icon2, label, ocid }) => {
                  const isActive = location2.pathname === to;
                    ...
                    ${isActive ? "text-[#00A3FF]" : "text-muted-foreground hover:text-foreground hover:bg-[#1E2A45]"}`,
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", children: [
                          ...
                          isAlerts && unreadAlertCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: "absolute -top-1 -right-1 w-3 h-3 rounded-full flex items-center justify-center text-[7px] font-bold",
                              style: { backgroundColor: "#FF3B3B", color: "#fff" },
                              children: unreadAlertCount
                            }
                          )
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden lg:block text-xs font-bold tracking-wider font-display uppercase", children: label })
                      ]
                    },
                    to
                  );
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden lg:block", children: "v2.0.0" })
                  }
                )
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "nav",
          {
            ...
            children: NAV_ITEMS.map(({ to, icon: Icon2, label, ocid }) => {
              const isActive = location2.pathname === to;
              const isAlerts = to === "/alerts";
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                ...
                ${isActive ? "text-[#00A3FF]" : "text-muted-foreground hover:text-foreground"}`,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold tracking-widest font-display uppercase", children: label }),
...
function ToastItem({ toast }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 pl-3 pt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4", style: { color: ICON_COLORS[toast.type] } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex-1 text-xs leading-5 text-foreground font-body", children: toast.message }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function ToastContainer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      ` }),
        visible.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToastItem, { toast: t }, t.id))
      ]
    }
  );
}
const LoginPage = reactExports.lazy(
  () => __vitePreload(() => import("./Login-CT_lq6Gr.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0).then((m) => ({ default: m.LoginPage }))
);
const DeviceSetupPage = reactExports.lazy(
  () => __vitePreload(() => import("./DeviceSetup-BFkKlhEh.js"), true ? __vite__mapDeps([4,1,5,6]) : void 0).then((m) => ({ default: m.DeviceSetupPage }))
);
const DashboardPage = reactExports.lazy(
  () => __vitePreload(() => import("./Dashboard-CocZ1MbG.js"), true ? __vite__mapDeps([7,8,9,6,3]) : void 0).then((m) => ({ default: m.DashboardPage }))
);
const AlertsPage = reactExports.lazy(
  () => __vitePreload(() => import("./Alerts-DBhlOiGB.js"), true ? __vite__mapDeps([10,8]) : void 0).then((m) => ({ default: m.AlertsPage }))
);
const SettingsPage = reactExports.lazy(
  () => __vitePreload(() => import("./Settings-Abrczxiv.js"), true ? __vite__mapDeps([11,2,9,5]) : void 0).then((m) => ({ default: m.SettingsPage }))
);
const PageLoader = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "div",
  {
...
const rootRoute = createRootRoute({
  component: () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      alarm && /* @__PURE__ */ jsxRuntimeExports.jsx(AlarmOverlay, {}),
...
function LoginRouteComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {}) });
}
...
const setupRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/setup",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DeviceSetupPage, {}) })
});
const dashboardRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/dashboard",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardPage, {}) }) })
});
const alertsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/alerts",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AlertsPage, {}) }) })
});
const settingsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/settings",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPage, {}) }) })
});
...
export {
  ...
  User as U,
  X,
  useRakshakStore as a,
  CircleCheck as b,
  createLucideIcon as c,
  MOCK_DEVICES as d,
  useAuthGuard as e,
  useDeviceStatus as f,
  getDevices as g,
  ChevronDown as h,
  useAlarm as i,
